    ...
    <div className="flex justify-center py-6">
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-screen-xl px-4 max-w-80p">
        ...
        <h1 className="relative text-6xl md:text-5xl font-bold text-black mb-4 mt-[3em]">
          ...
          <Fade direction='down' duration={2000}>I am a developer with over 9 years experience. I build Web and Mobile applications with JavaScript, React/Angular, PHP, Laravel/CakePHP, Bootstrap, Flexbox, and other cool libraries and frameworks. I also have a background in graphic design which has been a useful skill for smaller companies or for hot fixes.</Fade>
          </p>
        </div>
