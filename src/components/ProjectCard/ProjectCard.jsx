...
const ProjectCard = ({ cardInfo }) => {
  ...
  return (
    <div className="second hero inline-block relative sm:w-full sm:max-w-[300px] lg:max-w-[500px] lg:min-w-[300px] min-w-0 h-[400px] bg-slate-800 rounded-[30px] overflow-hidden border border-2 border-white shadow-lg m-8 hover:shadow-lg">
      ...
      <div className="absolute bottom-[20%] left-8 text-white lg:max-w-[50%] sm:max-w-[80%] mr-[10%] sm:mx-auto text-left">
        ...
        <div className="hero-btn absolute right-8 bottom-[5%] py-2 px-4 bg-red-800 hover:bg-red-700 rounded-md pointer">
