...
const Footer = () => {
    const { navLinks, navCopyright, navGithub } = navigation;
        ...
        <section className="bg-slate-800 relative">
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mt-8 space-x-6">
                    <a href={navGithub.href} target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-gray-200">
                        <span className="sr-only">{navGithub.label}</span>
